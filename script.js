...
function getRandom(arr) {
  ...
  var randomElement = arr(randomIdx)
  return
}
// function getRandomitem(list) {
//   console.log(specialcharacters, "list")
//   return list[randomInt(specialcharacters, lowercaseletters, uppercaseletters, numbers)]
// }
...
function generatePassword() {
  ...
  for (var i = 0; i <= passwordLength; i++) {
    ...
    // console.log(randomList, "random list")
    // var randomCharacter = getRandomitem(randomList)
    // console.log(randomCharacter, "randomCharacter")
    var randomCharacter = optionscart[Math.floor(Math.random() * passwordLength)]
